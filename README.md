...
А имеет 100 оценок "5" и 10 оценки "4", в то время как товар Б имеет 3 оценки "5". Если 
...
повторной обработки запросов на обновление рейтина из-за возможных сбоев в работе Kafka, так как
